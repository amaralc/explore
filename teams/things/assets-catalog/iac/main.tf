locals {
  service_name              = "things-assets-catalog" # The name of the system component composed as "<team>-<service>"
  is_production_environment = var.source_environment_branch_name == null ? true : false
}

module "mongodb_instance" {
  source                     = "../../../kernel/iac-modules/mongodb-dbms-environment"
...
module "mongodb_database_and_access_management" {
  source                         = "../../../kernel/iac-modules/service-with-mongodb-access"
