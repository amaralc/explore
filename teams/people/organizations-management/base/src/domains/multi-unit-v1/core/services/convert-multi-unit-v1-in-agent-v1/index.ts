...
import { IConvertMultiUnitV1InAgentV1InputDto } from './dto';

export class ConvertMultiUnitV1InAgentV1Service {
  static execute(inputDto: IConvertMultiUnitV1InAgentV1InputDto): IAgentV1Dto {
    const id = hashIntegerAndEntityNameIntoValidFirebaseUID(inputDto.id, 'MultiUnitV1');
