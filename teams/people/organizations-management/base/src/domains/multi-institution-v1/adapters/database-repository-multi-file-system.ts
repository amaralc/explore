...
export class FileSystemMultiInstitutionsV1Repository implements MultiInstitutionsV1DatabaseRepository {
  constructor(
    private readonly multiInstitutionsV1JsonFilePath = 'teams/people/organizations-management/base/src/domains/_shared/core/use-cases/extract-entities-from-external-source/fixtures/multi-institutions-v1-response-body.json',
  ) {}
