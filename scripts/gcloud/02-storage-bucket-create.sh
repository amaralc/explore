...
# Call this script with the following command: bash ./scripts/gcloud/01-storage-bucket-create.sh --project-id=PROJECT_ID --location=LOCATION --bucket-name=BUCKET_NAME
