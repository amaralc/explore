...
module "researchers-peers-svc-rest-api" {
  ...
  gcp_direct_database_connection_url_secret_id = google_secret_manager_secret.direct_url_secret.id   # The ID of the database connection URL secret
  gcp_pooled_database_connection_url_secret_id = google_secret_manager_secret.database_url_secret.id # The ID of the database connection URL secret
