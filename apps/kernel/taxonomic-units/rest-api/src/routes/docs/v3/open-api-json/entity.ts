import agentV1DtoJsonSchema from '@peerlab/kernel/taxonomic-units/base/domains/agents-v1/core/entity.schema';
import organizationV1JsonSchema from '@peerlab/kernel/taxonomic-units/base/domains/organizations-v1/core/entity.schema';
import userV1JsonSchema from '@peerlab/kernel/taxonomic-units/base/domains/users-v1/core/entity.schema';
