...
export class FileSystemMultiCentralsV1Repository implements MultiCentralsV1DatabaseRepository {
  constructor(
    private readonly multiCentralsV1JsonFilePath = 'apps/kernel/taxonomic-units/base/src/domains/_shared/core/use-cases/extract-entities-from-external-source/fixtures/multi-centrals-v1-response-body.json',
  ) {}
