...
describe('ExtractEntitiesFromExternalSourceUseCase', () => {
  ...
  it('should update entities in dataset if they already exist', async () => {
    ...
    const multiInstitutionsV1UpdatedDatabaseRepository = new FileSystemMultiInstitutionsV1Repository(
      'apps/people/organizations-management/base/src/domains/_shared/core/use-cases/extract-entities-from-external-source/fixtures/multi-institutions-v1-updated-response-body.json',
    );
    const multiCentralsV1UpdatedDatabaseRepository = new FileSystemMultiCentralsV1Repository(
      'apps/people/organizations-management/base/src/domains/_shared/core/use-cases/extract-entities-from-external-source/fixtures/multi-centrals-v1-updated-response-body.json',
    );
