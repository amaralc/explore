...
locals {
  ...
  jdbc_database_url = "jdbc:postgresql:///${local.database_name}?cloudSqlInstance=${var.gcp_sql_dbms_instance_connection_name}&socketFactory=com.google.cloud.sql.postgres.SocketFactory"
}
